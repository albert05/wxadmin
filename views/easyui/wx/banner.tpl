...
$(function(){
    ...
    $("#datagrid").datagrid({
        ...
        columns:[[
            ...
            {field:'Title',title:'标题',width:100,align:'center',editor:'text'},
            {field:'ImgUrl',title:'图片地址',width:100,align:'center',editor:'text'},
            {field:'JumpUrl',title:'跳转地址',width:100,align:'center',editor:'text'},
...
<div id="dialog" title="添加banner" style="width:400px;height:300px;">
    <div style="padding:20px 20px 40px 80px;" >
        <form id="form1" method="post">
            <table>
                ...
                <tr>
                    <td>图片地址：</td>
                    <td><input name="ImgUrl" class="easyui-validatebox" required="true"  /></td>
                </tr>
                <tr>
                    <td>跳转地址：</td>
                    <td><input name="JumpUrl" class="easyui-validatebox" required="true"  /></td>
                </tr>
                <tr>
                    <td>状态：</td>
                    <td>
